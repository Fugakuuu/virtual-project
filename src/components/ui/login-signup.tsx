...
export default function LoginCardSection() {
  ...
  return (
    <section className="fixed inset-0 bg-zinc-950 text-zinc-50 z-50">
      <style>{`
      ...
      <div className="h-full w-full grid place-items-center px-4">
        <Card className="card-animate w-full max-w-sm border-zinc-800 bg-zinc-900/70 backdrop-blur supports-[backdrop-filter]:bg-zinc-900/60">
          ...
          <CardContent className="grid gap-5">
            ...
            {step === "identifier" && (
              <form onSubmit={handleIdentifierSubmit} className="grid gap-5">
            ...
            {step === "social-redirect" && (
              <div className="grid gap-5">
                <p className="text-sm text-zinc-300 text-center">
                  This account is managed by <span className="font-semibold text-zinc-100">{emailInfo?.providers?.[0]?.toUpperCase()}</span>.<br />
          ...
          {step === "identifier" && (
            <CardFooter className="flex items-center justify-center text-sm text-zinc-400">
              ...
              <a className="ml-1 text-zinc-200 hover:underline cursor-pointer" onClick={() => setStep("register")}>
                Create one
              </a>
            </CardFooter>
          )}
